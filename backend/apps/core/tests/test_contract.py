...
def test_openapi_schema_contains_core_contract_endpoints():
    ...
    required: dict[str, set[str]] = {
        ...
        "/api/v1/editorial/tracks": {"get", "post"},
        "/api/v1/editorial/tracks/{uuid}": {"get", "put", "patch", "delete"},
        "/api/v1/shows": {"get", "post"},
        "/api/v1/shows/{uuid}": {"get", "put", "patch", "delete"},
        ...
        "/api/v1/audit/api-requests": {"get"},
        "/api/v1/audit/background-jobs": {"get"},
        "/api/v1/audit/background-jobs/{uuid}/retry": {"post"},
        "/api/v1/audit/background-jobs/{uuid}/cancel": {"post"},
        "/api/v1/audit/change-logs": {"get"},
        "/api/v1/audit/error-logs": {"get"},
        "/api/v1/audit/error-logs/{uuid}/resolve": {"post"},
        "/api/v1/audit/login-history": {"get"},
        "/api/v1/audit/tracks": {"get", "post"},
        # Intelligence
