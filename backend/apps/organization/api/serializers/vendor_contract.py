...
class VendorContractSerializer(BaseReadSerializer):
...
class VendorContractCreateSerializer(BaseWriteSerializer):
...
class VendorContractUpdateSerializer(BaseWriteSerializer):
    class Meta:
        model = VendorContract
        fields = (
            "contract_number",
