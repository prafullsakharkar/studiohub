...
class UserRoleBaseSerializer(OrganizationEntitySerializer[UserRole]):
    """
...
class UserRoleAssignSerializer(serializers.Serializer[Any]):
    """
...
class UserRoleRevokeSerializer(serializers.Serializer[Any]):
    """
