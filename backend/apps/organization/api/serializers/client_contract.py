...
class ClientContractSerializer(BaseReadSerializer):
...
class ClientContractCreateSerializer(BaseWriteSerializer):
...
class ClientContractUpdateSerializer(BaseWriteSerializer):
    class Meta:
        model = ClientContract
        fields = (
            "contract_number",
