"""
Organization Setting validator.
"""
...
class OrganizationSettingValidator(SettingsBaseValidator):
    """
    Validator for OrganizationSetting.
    """
    ...
    def validate_organization(self, organization_id: str) -> bool:
        """
        ...
        try:
            ...
            self.errors["organization"] = [f"Organization '{organization_id}' does not exist"]
            return False
